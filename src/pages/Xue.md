...
In Traditional Chinese Medicine, **Xue** (pronounced _shway_, often translated as "Blood") is one of the fundamental substances essential for sustaining life. But its definition goes far beyond the physical red fluid measured in Western medicine. In TCM, Xue is understood as a dense, material form of vital energy (Qi) that continuously nourishes, moistens, and anchors the body and mind.

## The origin and formation of Xue
...
Xue cannot be understood without Qi. They share a deeply symbiotic, Yin-Yang relationship summarized by the TCM maxim: _"Qi is the commander of Blood; Blood is the mother of Qi."_

| Concept         | Role in the relationship                                                                                    | Modern analogy    |
| --------------- | ----------------------------------------------------------------------------------------------------------- | ----------------- |
| Qi guides Blood | Qi provides the motive force that pushes Xue through the vessels. Without Qi, Xue stagnates.                | The engine/pump   |
| Blood houses Qi | Xue is material and acts as a physical vehicle. It carries Qi throughout the body so it does not dissipate. | The fuel/carriage |

## Primary functions of Xue
...
Xue ensures that joints and muscles remain lubricated and responsive. A lack of Xue nourishment can manifest as numbness in the limbs, stiffness, or tremors.

## Xue and the menstrual cycle

The menstrual cycle is the most legible readout of a woman's Xue health. Each of the four phases has a characteristic Xue movement:

| Phase                                       | TCM character                 | Xue movement                                                                                                                                                                               |
| ------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Menstruation (days 1–5)**                 | Yang declining, Yin ascending | Xue descends and is released; the Chong Mai ([Penetrating Vessel](Jingmai.md)) empties downward. The emphasis is on smooth, unobstructed outflow.                                          |
| **Follicular / post-menstrual (days 6–13)** | Yin rising                    | Xue and Yin rebuild in the Uterus and Liver. The Spleen's manufacturing role is most active here; nourishing Xue is the treatment priority.                                                |
| **Ovulation (around day 14)**               | Yin peaks, Yang rises         | Xue and Qi surge outward. This brief pivot requires smooth Liver Qi to prevent Xue from stagnating as the cycle shifts direction.                                                          |
| **Luteal / pre-menstrual (days 15–28)**     | Yang dominant                 | Qi and Yang warm and contain Xue in preparation for either implantation or shedding. Pre-menstrual tension often reflects Liver Qi constraint failing to move Xue smoothly toward release. |
...
TCM reads Xue through the pulse, tongue, and visual signs of the face, lips, and nails. For the broader diagnostic framework these sit inside, see [SiZhen.md](SiZhen.md).
...
## Foods and herbs that build Xue

### Core blood-building herbs
...
Three points form the backbone of Xue-focused acupuncture treatment. They are frequently combined; their upper/lower body coverage is complementary.
